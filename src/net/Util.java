...
public class Util {
    ...
    public static int START_UPDATE_MOVEABLE         = 0x03;
    public static int START_DROP_BOMB               = 0x04;
    ...
    public static int END_UPDATE_MOVEABLE           = 0x30;
    public static int END_DROP_BOMB                 = 0x40;
